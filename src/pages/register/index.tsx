...
const schema = z.object({
  name: z.string().nonempty("O campo nome e obrigatório"),
  email: z.string().email("Insira um email válido").nonempty("O campo email e obrigatorio"),
  password: z.string().min(6, "A senha deve ter pelo menos 6 caracteres").nonempty("O campo senha e obrigatório")
})
